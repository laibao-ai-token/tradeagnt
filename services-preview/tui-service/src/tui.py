...
from .agent_shell import (
    AgentShellMessage,
    AgentShellState,
    agent_shell_signature as _agent_shell_signature,
    render_agent_message_lines as _render_agent_message_lines_impl,
    seed_agent_shell_state as _seed_agent_shell_state_impl,
    submit_agent_shell_input as _submit_agent_shell_input_impl,
)
...
def _seed_agent_shell_state() -> AgentShellState:
    return _seed_agent_shell_state_impl(
        default_log_path=_AGENT_EVENTS_LOG_PATH,
    )


def _submit_agent_shell_input(state: AgentShellState) -> bool:
    return _submit_agent_shell_input_impl(
        state,
        default_log_path=_AGENT_EVENTS_LOG_PATH,
    )
...
def _render_agent_message_lines(messages: Iterable[AgentShellMessage], width: int) -> list[tuple[str, str]]:
    return _render_agent_message_lines_impl(
        messages,
        width,
        wrap_text=_wrap_display_text,
        truncate=_truncate,
    )
